...
const hellodoctorSlice = createSlice({
    ...
    reducers: {
        ...
        editHelloDoctorVideos: (state, action) => {
            const index = state.videos.findIndex((videos) =>videos._id === action.payload._id);
...
export const { setHelloDoctorVideos, addHelloDoctorVideos, editHelloDoctorVideos, deleteHelloDoctorVideos } = hellodoctorSlice.actions;
