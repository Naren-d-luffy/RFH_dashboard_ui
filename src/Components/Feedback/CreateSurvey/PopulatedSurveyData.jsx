import { Divider, Form, Input, Checkbox, Button, Upload, Rate, Radio } from 'antd';
...
const PopulatedSurveyData = () => {
    ...
    const [questions, setQuestions] = useState([
        {
            id: 1,
            label: "1.Did you find the hospital signage and directions easy to follow?",
            type: "shortAnswer",
            value: "Ans :  Add a one-click option to download the contact information directly to my phone or email contacts",
        },
        {
            id: 2,
            label: "2. Did the staff explain your diagnosis and treatment plan clearly?",
            type: "shortAnswer",
            value: "Ans :  Add a one-click option to download the contact information directly to my phone or email contacts",
        },
        {
        ...
        },
        {
            ...
            type: "shortAnswer",
            value: "I am a software developer with a passion for learning new technologies.",
        },
        {
            id: 6,
        ...
        {
            id: 8,
            label: "8.Was the information provided by the doctor clear and easy to understand?",
            type: "checkbox",  
            options: [
        ...
        {
            id: 9,
            label: "9.Was the information provided by the doctor clear and easy to understand?",
            type: "checkbox",  
            options: [
                { label: "Yes, completely clear", value: "Yes, completely clear" },
            ],
                    ...
                    <div className="row pupulated-data-div">
                        <div className="col-lg-12">
                            {questions.map((question) => (
                                <Form.Item
                                    key={question.id}
                                    label={<span className="populated-survey-label">{question.label}</span>}
                                >
                                    <div className="populated-survey-values">{renderQuestion(question)}</div>
                                </Form.Item>
                            ))}
                        </div>
                    </div>
