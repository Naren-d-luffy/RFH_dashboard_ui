...
const UserManagementViewPatientsModal = ({ visible, onClose }) => {
    const dummyData = {
        name: "Kiran B K",
        id: "U121212",
        consultDr: "Dr. Sunil",
            ...
            >
                <div className="row mt-4">
                    ...
                    <div className="col-lg-6">
                        <Form.Item>
                            <select
                                className="form-select create-camapign-input readOnly-disabled-bg"
                                value={formData.type || ""}
...
export default UserManagementViewPatientsModal
