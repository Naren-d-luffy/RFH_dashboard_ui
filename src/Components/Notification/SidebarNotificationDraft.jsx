...
const SidebarNotificationDraft = () => {
    const notifications = [
        {
            status: "Completed",
    ...
    const completedNotifications = notifications.filter(notification => notification.status === "Draft");
    return (
...
export default SidebarNotificationDraft;
