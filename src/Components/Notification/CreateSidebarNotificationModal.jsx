        ...
        <div className="col-lg-10">
          <div>
            ...
            <Radio.Group value={selectedValue} onChange={handleRadioChange}>
              <Radio value="none" style={{ fontWeight: 400 }}>
                None
              </Radio>
              <Radio value="6hours" style={{ fontWeight: 400 }}>
                6 Hours
              </Radio>
              <Radio value="8hours" style={{ fontWeight: 400 }}>
                8 Hours
              </Radio>
              <Radio value="24hours" style={{ fontWeight: 400 }}>
                24 Hours
              </Radio>
            </Radio.Group>
          </div>
